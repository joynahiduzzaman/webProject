  ...
  <div class="first-bg">
    ...
    <div class="container" id="courses">
      <div class="d-flex justify-content-center categories">
        <h3 class="online-courses">Payment On Nagad</h3>
      </div>
    </div>
    ...
    <div class="container">
      <div class="half-width form-tab">
        <div class="form-floating">
          ...
          <label for="floatingPassword">Nagad Number</label>
        </div>
        <div class="form-floating">
        ...
        <div class="form-floating">
          <input type="number" class="form-control Amount" id="floatingAmount" placeholder="Amount">
          <label for="floatingAmount">Amount Money</label>
        </div>


        <div>
          <button class="button-form" name="donate">Donate</button>
        </div>
      </div>
    </div>
